...
{
    public partial class UserHalamanKuis2 : Form
    {
        int seconds = 0;
        ...
        private int vId;
        private int score;
        public UserHalamanKuis2(int vId, int score)
        {
            InitializeComponent();
            this.vId = vId;
        ...
        private void countdownTimer_Tick(object sender, EventArgs e)
        {
            ...
            if (seconds < 0)
            {
                ...
                var halamankuis2 = new UserHalamanKuis3(vId, int.Parse(label6.Text));
                this.Hide();
        ...
        private void UserHalamanKuis2_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            var halamankuis2 = new UserHalamanKuis3(vId, score);
            this.Hide();
            halamankuis2.ShowDialog();
        }
