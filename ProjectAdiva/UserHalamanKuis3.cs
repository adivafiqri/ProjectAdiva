...
{
    public partial class UserHalamanKuis3 : Form
    {
        int seconds = 0;
        ...
        private int vId;
        private int score;
        public UserHalamanKuis3(int vId, int score)
        {
            InitializeComponent();
            this.vId = vId;
            this.score = score;
        ...
        private void countdownTimer_Tick(object sender, EventArgs e)
        {
            ...
            if (seconds < 0)
            {
                ...
                var halamankuis4 = new UserHalamanKuis4(vId, int.Parse(label6.Text));
                this.Hide();
                halamankuis4.ShowDialog();
            }

        }

        private void UserHalamanKuis3_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            var halamankuis4 = new UserHalamanKuis4(vId, score);
            this.Hide();
            halamankuis4.ShowDialog();
        }
